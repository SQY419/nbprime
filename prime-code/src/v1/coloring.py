...
def Coloring(textl, fc, hl=1):
    ...
    if textl[0] == "#":
        ...
        return Ccol
    while j < len(textl):
        st = textl[j].upper() if UpperLowerKey == 1 else textl[j]
...
def drawSlider(g, l, y, t):
    if l > 8:
        ...
        c = rgb(200, 200, 200, 150) if t == 0 else rgb(100, 100, 100, 150)
...
def symPadGui(th):
    ...
    textout(3, 96, 82, "<", rgb(16777215 if th == 0 else 0))
    textout(3, 156, 82, "≤", rgb(16777215 if th == 0 else 0))
    textout(3, 216, 82, ">", rgb(16777215 if th == 0 else 0))
    textout(3, 96, 142, "≥", rgb(16777215 if th == 0 else 0))
    textout(3, 152, 142, "==", rgb(16777215 if th == 0 else 0))
    textout(3, 216, 142, "≠", rgb(16777215 if th == 0 else 0))
